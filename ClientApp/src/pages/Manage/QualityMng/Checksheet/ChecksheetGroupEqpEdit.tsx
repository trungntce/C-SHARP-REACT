...
const ChecksheetGroupEqpEdit = forwardRef((props: any, ref: any) => {
    ...
    return (
        <>
            <EditBase
                ref={ref}
                header="Check Sheet Group EQP"
                initHandler={initHandler}
                changeHandler={changeHandler}
                submitHandler={submitHandler}
            >
                <Row>
                    <Input name="groupType" type="hidden" value={"EQP"} required={true} autoComplete="off" className="form-control" />
                    <Col md={4}>
                        <div className="mb-3">
                    ...
                    <Col md={4}>
                        <div className="mb-3">
                            ...
                            <AutoCombo name="workcenterCode" required={true} placeholder="작업장코드" mapCode="workcenter" autoComplete="off" className="form-control"/>
                        </div>
                    </Col>
                    <Col md={4}>
                        <div className="mb-3">
...
export default ChecksheetGroupEqpEdit;
