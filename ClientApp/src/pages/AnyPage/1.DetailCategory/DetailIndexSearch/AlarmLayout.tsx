          ...
          <div className={myStyle.mainContainer}>
            ...
            <div className={myStyle.bottomContainer}>
              <div className={myStyle.count}>
                ...
                >
                  <div className={myStyle.valuelayout}>
                    {toComma(
                      selectedData?.prod_cnt
                        ? selectedData?.prod_cnt
                        : 0
                    )}
                    <div style={{ fontSize: "25px" }}>
                      {selectedData?.real?.prodCntUnit
                        ? selectedData?.real?.prodCntUnit
                        : "PNL"}
                    </div>
                  </div>
              ...
              <div className={myStyle.count}>
                {/* {CountCard(
                  "예상 생산량",
                  toComma(Math.round(selectedData?.real?.expectedProd)),
                  "#227A7D",
                  "",
                  "PNL"
                )} */}
                {CountCard("예상 생산량", "-", "#227A7D", "", "")}
                {/* {CountCard("LOT 생산량", `0`, "#8c53ac", "", "PNL")} */}
              ...
              <div className={myStyle.count}>
                ...
                {/* {CountCard(
                  "성능 가동률",
                  `${
                    selectedData?.real?.perforRate
                      ? selectedData?.real?.perforRate?.toFixed(0)
                      : 0
                  } %`,
                  "#00C9EC"
                )} */}
