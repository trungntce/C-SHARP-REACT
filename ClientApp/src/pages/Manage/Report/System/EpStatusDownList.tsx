...
import { DownListDefs } from "./EpStatusDefs";

const EpStatusDownList = () => {
  const { t } = useTranslation();

  const [searchRef, getSearch] = useSearchRef();
  const [gridRef, setList] = useGridRef();

  const { refetch } = useApi("DownList/epstatusdownlist", getSearch, gridRef);
...
export default EpStatusDownList;
