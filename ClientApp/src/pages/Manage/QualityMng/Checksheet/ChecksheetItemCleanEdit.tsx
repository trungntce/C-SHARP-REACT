...
const ChecksheetItemCleanEdit = forwardRef((props: any, ref: any) => {
    ...
    const initHandler = (formRef: any, init: Dictionary) => {
        ...
        if (initRow.current.itemCode) {
            form.current.elements["checksheetCode"].disabled = true;
        } else {
        }
    }
                ...
                <Row>
                    <Col md={6}>
                        <div className="mb-3">
                            ...
                            <Input name="checksheetCode" disabled type="text" required={true} autoComplete="off" className="form-control" />
                        </div>
                    </Col>
                    <Col md={6}>
                        <div className="mb-3">
                ...
                <Row>
                    ...
                    <Col md={6}>
                        <div className="mb-3">
                            ...
                            <Input name="remark" type="text" autoComplete="off" className="form-control" />
                        </div>
                    </Col>
                </Row>
            </EditBase>
...
export default ChecksheetItemCleanEdit;
