...
(
	...
	from
		tb_recipe_approve_request_data a
	inner join 
		tb_param_approve_request_data b 
	...
	and a.approve_yn	!= 'Y' and b.approve_yn != 'Y'
...
(
    ...
    ,   cte.approve_dt
    ,   (select approve_yn from tb_recipe_approve_request_data where model_code = cte.model_code and approve_dt = cte.approve_dt) as approve_yn
    ,   (select approve_key from tb_recipe_approve_request_data where model_code = cte.model_code and approve_dt = cte.approve_dt) as approve_key
from cte
)
select 
	cte2.*
