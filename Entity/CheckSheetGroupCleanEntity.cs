...
public class CheckSheetGroupCleanEntity : BaseEntity
{
...
public class ChecksheetGroupProdList : List<CheckSheetGroupCleanEntity>
{
    public ChecksheetGroupProdList(IEnumerable<CheckSheetGroupCleanEntity> list) : base(list)
    {
    }
