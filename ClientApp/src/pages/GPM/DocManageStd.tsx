...
const DocManageStd = () => {
    ...
    const { refetch } = useApi("DocManageStd?dept_filter=all", getSearch, gridCountRef);
            ...
            <ListBase
                ...
                <Row style={{ height: "99%" }}>
                    <Col md='12' style={{ height: "99%" }}>
                        <div style={{ width: "calc(100% - 85px)" }}><h5 style={{ paddingTop: '10px', paddingLeft: '6px' }} id="panelTitle">표준문서 관리</h5></div>
                        <GridBase
                            ref={gridCountRef}
